...
QtObject {
  ...
  property color backgroundColorHovered: theme.isDesktop ? Qt.lighter(backgroundColor, 1.2) : backgroundColor
  ...
  property color borderColorHovered: theme.isDesktop ? Qt.lighter(borderColor, 1.2) : borderColor
